...
@Component({
  selector: "tshop-conversation-item",
  templateUrl:'./tshop-conversation-item.component.html',
...
export class TShopConversationItemComponent implements OnInit, OnChanges  {
