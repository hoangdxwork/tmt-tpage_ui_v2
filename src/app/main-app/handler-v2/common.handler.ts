...
export class CommonHandler {
  ...
  public tdsDateRanges: TDSDateRangeDTO[] = [
    {id: 0, name:'Hôm nay', startDate: new Date(), endDate: new Date()},
    {id: 1, name:'Hôm qua', startDate: startOfYesterday(), endDate: endOfYesterday()},
    {id: 7, name:'7 ngày qua', startDate: subDays(new Date(), 7), endDate: new Date()},
    {id: 30, name:'30 ngày qua', startDate: subDays(new Date(), 30), endDate: new Date()},
