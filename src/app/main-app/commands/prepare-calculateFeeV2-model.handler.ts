...
export abstract class PrepareCalculateFeeV2Handler {

  static prepareCalculateFeeV2(saleModel: FastSaleOrder_DefaultDTOV2, quickOrderModel: QuickSaleOnlineOrderModel,
    shipExtraServices: Array<Ship_ExtrasServiceModel>,
    userInit: UserInitDTO,  enableInsuranceFee: boolean): any {
